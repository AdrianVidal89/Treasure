...
@admin.register(AportacionRecurrente)
class AportacionRecurrenteAdmin(admin.ModelAdmin):
    list_display = ('inversion', 'importe', 'dia_mes', 'fecha_inicio', 'fecha_fin', 'activa')
    list_filter = ('activa',)
